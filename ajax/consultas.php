...
switch ($_GET["op"]) {
    ...
    case 'lista_comportamiento':
        ...
        //$fecha_inicio = date("Y-m-d", strtotime($fecha_actual . " - 3 days"));
        ...
        <table id="dataco" class="table table-striped table-bordered table-condensed table-hover">
            <thead>
                ...
                <th style="width: 120px;">Comentarios</th>  <!--Agregado para mostrar los comentarios -->
                <?php }?>
                ...
                <tr>
                    ...
                    <td class="comentario">
                                ...
                                if ($regc != null) {
                                    ...
                                    echo "-"; // Texto predeterminado si el comentario está vacío
                                }
                                ?>
                            </td>
                ...
                $rsptacalif=$calificaciones->listar_calificacion($idalumno,$idcurso);
                  $regn=$rsptacalif->fetch_object();?>
                     <td><?php if($regn!=null ){
                                 ...
                                 ?></td>
                                 <td <?php if ($regn != null) {
    if ($regn->Estado == "APROBADO") {
        echo 'style="background-color: green; color: white;"';
    } elseif ($regn->Estado == "REPROBADO") {
