...
// Agregar esta función a la clase Grupos en "Grupos.php"
...
{
	$sql = "DELETE FROM team WHERE idgrupo = '$idgrupo'";
	if (ejecutarConsulta($sql)) {
		// Ahora, eliminemos los registros relacionados en alumn_team
		$sql_alumn_team = "DELETE FROM alumn_team WHERE team_id = '$idgrupo'";
		ejecutarConsulta($sql_alumn_team);
		return true;
	} else {
		return false;
	}
