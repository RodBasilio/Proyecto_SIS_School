...
<div class="box-header with-border">
  <h1 class="box-title">Informacion Alumnos: <?php echo $nombre_grupo; ?> <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar Alumno</button>  </h1>
