...
if ($_SESSION['escritorio']==1) {
  echo ' <li><a href="escritorio.php"><i class="fa  fa-dashboard (alias)"></i> <span>Escritorio</span></a>
        ...
        ?>
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-th-large"></i> <span>Menu Curso</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li><a href="vista_grupo.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Panel de Control</a></li>
          </ul>
          <ul class="treeview-menu">
          <li><a href="asistencia.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Asistencia</a></li>
          </ul>
          <ul class="treeview-menu">
          <li><a href="conducta.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Conducta</a></li>
          </ul>
          <ul class="treeview-menu">
          <li><a href="calificaciones.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Calificaciones</a></li>
          </ul>
          <ul class="treeview-menu">
          <li><a id="btncursos" href="cursos.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Materias</a></li>
          </ul>
          <ul class="treeview-menu">
          <li><a id="btnlistas" href="listasis.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Lista</a></li>
          </ul>
          <ul class="treeview-menu">
          <li><a id="btnlistas" href="vista_info_alum.php?idgrupo=<?php echo $_GET["idgrupo"]; ?>"><i class="fa fa-circle-o"></i> Informacion Alumnos</a></li>
          </ul>
